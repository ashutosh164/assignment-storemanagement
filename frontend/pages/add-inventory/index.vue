...
<div class="flex min-h-full flex-1 flex-col justify-center py-5 sm:px-6 lg:px-8">
   <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <h2 class="mt-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Add inventory</h2>
   </div>
   <div class="mt-2 sm:mx-auto sm:w-full sm:max-w-[480px]">
      <div class="bg-white px-6 py-3 shadow sm:rounded-lg sm:px-12">
         <form class="space-y-2" action="#" method="POST">
            ...
            <div>
               <button @click.prevent="addInventory()" type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
            </div>
